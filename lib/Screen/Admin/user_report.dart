    ...
    title: Text(
      ...
      actions: [
         Padding(
           ...
           child: CircleAvatar(
                    radius: 20,
                   child: Text( userCount.isNotEmpty 
                  ? "${userCount[0]['count(*)'].toString()}"
                  : "0",), 
                  ),
         )
      ],
          ...
          child:
           Container(
             ...
             child: userList.isNotEmpty ? ListView.builder(
                        ...
                        child: Row(
                            ...
                            children: <Widget>[
                              new RaisedButton(
                                ...
                                onPressed: () async{
                                var id = userList[index]['customer_id'];
                                  await http.post(Uri.parse("https://saniabdullahi.com.ng/result.php"), body: {
                                      "request": "DELETE USER",
                                      "id": id,
                                      });
              ...
              ) :   Center(child: Text('No user found!', style: TextStyle(color: Constant.kPrimaryColor.withOpacity(0.8), fontSize: 18),),),
           ),
          ),
